...
<body class="g-sidenav-show   bg-gray-100">
                    ...
                    <div class="card z-index-2 h-100">
                        <div class="card-header pb-0 pt-3 bg-transparent">
                            ...
                            <p class="text-sm mb-0" style="text-align: center;">
                                <span class="font-weight-bold">Berapa jumlah order quantity di wilayah yang ada di
                                    territory_group "North America" pada tahun 2003?</span>
    ...
    <script>
        ...
        $query = "SELECT t.territory_name, SUM(fp.orderqty) AS total_order_qty 
              ...
              WHERE t.territory_group = 'North America' AND d.year = 2003 
        ...
        var options = {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Total Order Quantity in North America (2003)',
                    font: {
                        size: 16
                    }
                }
