...
<body class="g-sidenav-show   bg-gray-100">
                ...
                <div class="col-lg-12 mb-lg-12 mb-4">
                    <div class="card z-index-2 h-100">
                        <div class="card-header pb-0 pt-3 bg-transparent">
                            ...
                            <span class="font-weight-bold">Berapa total order quantity pada tahun 2001 - 2004?</span> 
    ...
    <?php
    $query = "SELECT d.year, SUM(fp.orderqty) AS total_order_qty 
              FROM sales_fact fp 
              JOIN time_dim d ON fp.time_id = d.time_id 
              WHERE d.year BETWEEN 2001 AND 2004 
              GROUP BY d.year 
              ORDER BY d.year";
    $result = mysqli_query($conn, $query);

    $years = range(2001, 2004);
    $totalOrderQtyData = array();

    while ($row = mysqli_fetch_assoc($result)) {
        $totalOrderQtyData[] = $row['total_order_qty'];
    }
