...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <script>
        ...
        <?php
        $query = "SELECT p.product_name, SUM(sf.totaldue) AS total_due FROM sales_fact sf JOIN product_dim p ON sf.product_id = p.product_id JOIN time_dim d ON sf.time_id = d.time_id WHERE (p.product_name = 'AWC Logo Cap' OR p.product_name = 'LL Road Frame - Red, 52') AND d.year = 2001 GROUP BY p.product_name";
